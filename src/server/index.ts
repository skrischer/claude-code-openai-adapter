...
export interface ServerConfig {
  port: number;
  host?: string;
  /** Working directory for Claude CLI subprocesses (defaults to os.homedir()) */
  cwd?: string;
}
 ...
 */
function createApp(cwd?: string): Express {
  const app = express();

  // Store cwd for subprocess spawning (accessed via req.app.locals in routes)
  app.locals.subprocessCwd = cwd;
